...
| Framework-positioning disciplines | **v1.0.0 canonical 2026-05-06** — 9 disciplines (FPD-1 through FPD-9) governing how the framework gets positioned to audiences (interview subjects, gatekeepers, working subjects, future readers). Surfaced 2026-05-05 → 2026-05-06 during Ch 3 fieldwork outreach pipeline + Darity interview prep. Includes: public-record screen, AI-disclosure first-contact-only, forwardability criterion, formality discipline, pre-read brief structure, two-artifact pair (pre-read + interview prep), attribution protocol with Q0 + four preference categories, scope-explicitness ("lead them to water" — both regimes named explicitly with example pairs), substantive background brief (subject's body of work + stances; drafted EARLY to inform the interview prep doc). | [`alignment/commons_bonds_framework_positioning_disciplines_v1.0.0.md`](alignment/commons_bonds_framework_positioning_disciplines_v1.0.0.md) |
