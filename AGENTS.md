...
| Pipeline doctrine | **v1.0.0 + Amendment A (selective stage-firing, ratified 2026-05-18) + Amendment B (Pass 3.5 developmental-edit, ratified 2026-05-18)** — six-stage architecture (Stage 0 → 1 [1a invariant + 1b structure + 1c coherence] → 2 → 3 [3.1 fact-check + 3.2 voice-polish + 3.3 acceptance + 3.4 robustness + **3.5 developmental-edit**] → 4 render-integrity → 5 sign-off bookend + pre-pub review queue) + continuous invariant-gate scans + two-class change-cascade routing (automatic-on-edit: Pass 3.1+3.2; explicit-gate: Pass 3.3+3.4+3.5+Stage 4+Stage 5) + single-pipeline content-type sub-protocols + cross-chapter workstream lifecycle. Hybrid versioning: memory entry summary at `feedback_audience_aware_drafting_discipline.md` v3.1.0 (memory-update spec at `tools/memory-updates/`) + full canonical doctrine in repo. All 11 original decisions ratified 2026-05-17; Amendment A + Amendment B ratified 2026-05-18. Per-chapter retrofit workstreams + per-chapter developmental-edit workstream both in flight. | [`tools/commons_bonds_pipeline_doctrine_v1.0.0.md`](tools/commons_bonds_pipeline_doctrine_v1.0.0.md) · [`stage-1`](tools/commons_bonds_pipeline_doctrine_stage_1_v1.0.0.md) · [`stage-4`](tools/commons_bonds_pipeline_doctrine_stage_4_v1.0.0.md) · [`stage-5`](tools/commons_bonds_pipeline_doctrine_stage_5_v1.0.0.md) |
