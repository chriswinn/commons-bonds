...
| Vocabulary strategy | **v1.0.1 canonical** — §3.1 Tier disambiguation note added 2026-04-30 (Insight #63 quick-fix). §6 + §7 + §13 light-trace migration to retirement archive queued under refined WP#4. | [`alignment/commons_bonds_vocabulary_strategy_v1.0.1.md`](alignment/commons_bonds_vocabulary_strategy_v1.0.1.md) |
| Terms index | **v0.1.0 current** — v1.0.0 version bump queued (applies summary-level retirement traces per refined WP#4; full traces migrate to retirement-archive index). | [`core/terms/terms_index.md`](core/terms/terms_index.md) |
