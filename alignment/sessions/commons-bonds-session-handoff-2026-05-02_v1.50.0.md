...
| **#21** | Tech Appendix + Ch 6 HTML structural placement (Tech Appendix v2.0.0 ✓; Ch 6 HTML format-conversion ✓; structural placement of supplementary §6.5–§6.10 passages PENDING) | OPEN; UNBLOCKED by α.2 + α.3 | dedicated session for ~13 placements + ~5,000 words structural integration |
