...
| `commons_bonds_abundance_layers_v1_0_0.md` | Superseded by retitle + patch 2026-04-22 | **DONE** — retitled to `commons_bonds_abundance_dimensions_v1_2_0.md`; §2 dimension-name propagation carried (Habitability, Kindred, Ecosystem locked); §5.5 availability-absence severity-marker + §5.6 lived-experience-canonical-case methodology still pending for a follow-up v1.1.1 patch. |
...
| `commons_bonds_rigor_protocol_v1.3.0.md` | Canonical rigor protocol | **PATCH** (layer → dimension throughout; bump to v1.2.2 for terminology patch only) |
...
- `tools/commons_bonds_rigor_protocol_v1.3.0.md` — canonical rigor protocol (PATCH target).
