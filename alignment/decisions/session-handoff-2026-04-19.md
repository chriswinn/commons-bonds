...
- **Glossary (WS02)** – new entries for _Structural Allocation_ (mechanism) and _Shielding / Distance_ (condition); revise _Cost Severance_ entry to reflect the split.
...
Direct consequence of Refinement 2. Six of eight canonical tiers are scale-locked in surface language (1, 2a, 3, 5, 7, 8). Revise each to scale-abstract core + manifestations paragraph. Tier 2a rename required.
...
Current framework delivers **narrow novelty** – integration that does new work – which is the signature of important frameworks (Darwin, Keynes, Piketty, Desmond, Raworth). The success metric (labor lawyer using "severed cost" in 10 years, judge doesn't need it explained) is a narrow-novelty success metric by design. Do not overclaim broad novelty in Chapter 6 prose; lean into integration claims which are defensible and strong.
