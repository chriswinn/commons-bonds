...
|---|---|---|
| `manuscript/technical-appendix/archive/TechnicalAppendix_v0.0.5_supplement.md` §6.2 (Four Gates admission apparatus) | "The gates filter cost *claims* against established commons; they do not filter what counts as a *commons*" — CIT positioned as admission-filter, not as empirical falsification. | CORRECT — explicit. |
| `alignment/methodology/cit_examples_v1_0_0.md` §6 (Gates as a complete admission apparatus) | Gates positioned as admission apparatus for cost claims. | CORRECT — explicit. |
...
- `manuscript/technical-appendix/archive/TechnicalAppendix_v0.0.5_supplement.md` §6.1.1 (level-of-claim refinement, 2026-04-25) — companion CIT-formal-spec refinement closing M11 Char 12.
- `manuscript/technical-appendix/archive/TechnicalAppendix_v0.0.5_supplement.md` §6.2 — Four Gates admission apparatus (where CIT is correctly positioned as admission-filter).
- `alignment/methodology/cit_examples_v1_0_0.md` — seven worked CIT applications through Four Gates.
