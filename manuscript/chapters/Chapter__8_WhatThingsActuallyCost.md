...
dashboard:
  chapter: 8
  chapter_title: What Things Actually Cost
  pipeline_stage: post-Stage-3 cascade complete + Stage 4 render audit + developmental edit review
  last_rigor_pass:
    date: 2026-05-26
    class: stage-4-render-audit
    artifact: tools/rigor-passes/ch8_stage_4_render_audit_2026-05-26.md
