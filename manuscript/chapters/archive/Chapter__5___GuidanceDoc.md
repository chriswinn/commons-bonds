...
| § Exxon Valdez case (line ~91) | **RESOLVED 2026-05-08** | Marked HISTORICAL inline (dropped from Ch 5 scope; backtest case retained in Ch 6 IPG convergence-table). Section preserved for historical reference. |
| § Baotou rare earths case (line ~100) | CURRENT | case data still in chapter (Ch 5 line ~56 onward); numerics aligned |
| § Social cost of carbon section (line ~109) | **RESOLVED 2026-05-08** | Marked HISTORICAL inline (relocated to Ch 6 lines 173, 185, 192, 202 in Phase 2 architectural sweep). Section preserved for historical reference. |
| § Pattern statement (line ~117) | CURRENT | still descriptive of chapter's structural argument |
| § Counterarguments / handling notes (line ~119) | **RESOLVED 2026-05-08** | Inline REGRESSED marker added; updated guidance reflects current 6-counterargument-engagement-subsection structure + Restitution/Foreclosure two-instrument apparatus. Original (now-superseded) note retained for historical reference. |
| § Missing from guidance (chapter has them; guidance doesn't reference) | **RESOLVED 2026-05-08** | New CURRENT Ch 5 case-list ADDITIONS section added: 2008 financial crisis + Social Security + Healthcare commons + Restitution/Foreclosure two-instrument apparatus (~1,800 words structural payoff, line ~205 in Ch 5, Insight #38 housing-crisis collision). |
...
All non-McDowell-County case studies, told briefly:

Libby, Montana:

- W.R. Grace mine, 80% of world vermiculite supply
- Asbestos contamination known to the company since at least 1963
- 400+ deaths, 3,000+ diagnosed with asbestos-related disease
- Mortality from asbestosis 40-80x the national average
- $600M+ in EPA cleanup, over 1 million cubic yards of contaminated soil removed
- $4 billion bankruptcy trust
- 35 million American homes potentially containing contaminated insulation
- First and only Public Health Emergency declared by EPA (2009)
- Mine lifetime revenue ~$100 million vs. costs >$4 billion. IPG ≈ 40-80x

Deepwater Horizon:

- Projected well lifetime revenue ~$4.25 billion
- $15 billion cleanup costs
- $20 billion economic damages
- $5.5 billion Clean Water Act penalty
- $8.8 billion natural resource damages
- $4 billion criminal fines
- Total >$65 billion. IPG ≈ 15x
- Largest environmental settlement in U.S. history, and costs continue

**[HISTORICAL — DROPPED FROM CH 5 SCOPE 2026-05-08; backtest case retained in Ch 6 IPG convergence-table; original Ch 5 inclusion superseded by current Ch 5 case-list (2008 + Social Security + Healthcare added; Exxon Valdez dropped)]**

Exxon Valdez:

- 11 million gallons spilled, market value ~$5.5 million
- Total social costs $5.5-9.5 billion
- 250,000 seabirds, 3,000 otters, 300 seals, 250 bald eagles, 22 killer whales killed
- Sea otter recovery took 25 years
- Herring never recovered
- Oil still present in sediments decades later

Baotou rare earths:

- 2,000 tons of toxic waste per ton of rare earth mined
- Cancer rates 70x national average near tailings lake
- 300 abandoned mines in Ganzhou alone
- 200 million tons of tailings, 100 square kilometers of forest destroyed
- Recovery estimated at 50-100 years
- "Cancer villages" with elevated cancer and birth defects

**[HISTORICAL — RELOCATED TO CH 6 lines 173, 185, 192, 202 in Phase 2 architectural sweep; SCC discussion now lives in Ch 6 where the model is formally presented + falsifiability test sits]**

The social cost of carbon as the closest existing attempt:

- Obama: $42/ton
- Trump: $1-7/ton
- Biden interim: $51/ton
- EPA 2023: $190/ton
...
**[CURRENT Ch 5 case-list ADDITIONS (per β.4 audit 2026-05-08; Ch 5 scope expanded beyond environmental cases to include financial + social-insurance + healthcare cost-severance):]**

2008 financial crisis (added to Ch 5):

- Risk severance via securitization + opacity (originate-to-distribute model)
- Profits captured by private actors; losses socialized via TARP + bailouts
- Demonstrates cost-severance mechanism extends beyond physical/environmental commons to financial commons (systemic risk)
- Counterargument-engagement subsection: addresses "but markets self-correct" objection by tracing the structural-absence-of-priced-systemic-risk-instrument

Social Security (added to Ch 5):

- Counter-case: shows what cost-severance LOOKS LIKE when the accountability instrument exists (intergenerational pooling + dedicated revenue stream)
- Demonstrates by contrast what's missing in extraction cases (no analogous instrument prices intergenerational foreclosure)
- Counterargument-engagement subsection: addresses "but governments can't be trusted with bonds" objection by pointing to 90-year operating record

Healthcare commons (added to Ch 5):

- Cost-severance via for-profit insurance intermediation + denial economics
- Profits captured by intermediaries; costs borne by patients + medical providers + uncompensated emergency care
- Demonstrates cost-severance mechanism in service commons (not just resource extraction)

**Restitution + Foreclosure two-instrument apparatus (added to Ch 5; ~1,800 words structural payoff):**

- Ch 5 introduces the two-instrument framework (Restitution Bond for past-tense accountability gaps; Foreclosure Bond for forward-looking pricing of permanent loss)
- This is the chapter's load-bearing structural payoff — the cases cumulate into demonstration that two distinct instruments are needed because two distinct accountability gaps exist
- Phase 2 Foreclosure Bond housing-crisis collision (Insight #38, ratified 2026-04-29) — bridge prose at first introduction; v1 DRAFT awaits author voice refinement
- Counterargument-engagement subsection: addresses "but Pigouvian taxes already do this" by distinguishing flow-pricing (Pigouvian) from stock-foreclosure-pricing (Foreclosure Bond)
...
Counterarguments woven in: **[REGRESSED 2026-05-08 — original advice "None explicitly in this chapter" is no longer accurate. Per β.4 audit, current Ch 5 contains 6 counterargument-engagement subsections embedded in the case sequence (one per case + the Restitution/Foreclosure-introduction passage). Original direction was "cases speak for themselves, methodological objections come in Ch 6"; current chapter lifts some objection-engagement into Ch 5 to land the two-instrument apparatus credibly. Ch 6 still carries the formal methodological objections.]** Original (now-superseded) note: None explicitly in this chapter. The cases speak for themselves. The methodological objections come in Chapter 6 when the model is formally presented.

How to handle this: Register 1 with data. Each case told as a compressed narrative — vivid, specific, human where possible (the Libby miner who can't breathe, the Gulf fisherman whose livelihood was destroyed). The data supports the story; the story carries the argument. The chapter ends with the pattern made explicit and the question posed: "If this is the pattern, can we measure the gap?"
