# Noema Essay — Drafting Plan (2026-05-08)

**Date drafted:** 2026-05-08  ·  **Date modified:** 2026-05-08

**Status.** Operational drafting plan derived from the REVISION 2026-05-08 section of `rewrite-plan_2026-05-01.md` (canonical structure source). This file foregrounds *what can be drafted now* vs. *what is blocked* so a drafting session can pick up unblocked sections immediately without re-deriving the structure.

**Source artifacts.**
- Section structure: `rewrite-plan_2026-05-01.md` REVISION 2026-05-08 (canonical)
- Voice + paraphrase source: `manuscript/chapters/Chapter__1_TheQuietMath__Draft.md` (~3,400 words; tentatively final 2026-05-04)
- Cluster γ material: `manuscript/chapters/Chapter__9_PricingHonestly__Draft.md` + `Chapter_10_CommonBonds__Draft.md`
- Norway material: `manuscript/chapters/Chapter__4_THEEXISTENCEPROOF__Draft.md`
- Framework naming source: `manuscript/chapters/Chapter__5_THEACCOUNTABILITYGAP__Draft.md` + `Chapter__6_ThreeWaysofCounting__Draft.html` (plain-language paraphrase, no math)
...
| Section | Words | Status | Drafted-able now | Blocked / by what |
|---|---|---|---|---|
| **I — Vignette opener** (plane / sunrise / NICU) | ~600 | **Unblocked** | Paraphrase Ch 1 ¶¶1–4 | — |
...
### Phase 1 — Ch 1 paraphrase (largest unblocked chunk; locks voice)

~2,100 words across Sections I, II, III, and Close. Single source (`Chapter__1_TheQuietMath__Draft.md`); single voice register. Recommend doing all four sections in one pass to keep voice consistent.

- **Section I (~600w):** Plane scene, daydreaming voice, son in NICU thoughts, transition into father-mountain hunting (Ch 1 ¶¶1–4)
- **Section II (~700w):** Pooh + air compressor + drill bits; "would you be proud" parenting; Pou nickname; NIH origins; 120-hour weeks; cable TV station rescue (Ch 1 middle)
- **Section III (~600w):** DMV commute + 1300 hours math; age-38-on-plane "quiet math"; parents-aging displacement (Ch 1 second half through ¶ around line 89)
- **Close (~200w):** Framework as honest accounting; for the ones who come after; sun was up, work to do (Ch 1 final paragraph)

**Discipline.** Noema's "we only publish original content" rule means *no sentence reuse* between Ch 1 and the essay. Same scenes, same arc, same ideas — different phrasings, sentence structures, transitions. Ch 1 is scaffolding, not source text to copy.

### Phase 2 — Section IV (Framework named, brief)

~400w of NEW prose. Two paragraphs in plain language:

1. **Cost severance** — the structural mechanism that separates value-capture from cost-bearing. Paraphrase from Ch 5 framing; no math, no formal apparatus.
2. **Residual Commons Value (RCV)** — what an honest accounting would price. Paraphrase from Ch 6 / Ch 9 framing; gesture at the apparatus without exposition.
...
Per Noema's pitch model (hook → tension → plan → solutions → characters → differentiation), the pitch can be drafted now alongside Phase 1–3 essay work. Slots that need filling once V + VI complete: characters paragraph (interviewees if Darity / Colden material lands; otherwise framework-character anchors).

### AI-collaboration disclosure (already drafted)

Use the Noema variant from `publishing/essay-drafts/templates/ai-disclosure-paragraph.md`. Place at the bottom of the cover note OR as essay footer per Noema guidelines. No drafting needed — drop in at submission time.
...
## Submission checklist (when all sections land)

- [ ] Full essay draft (~3,700 words; inside Noema's 2,500–4,000 band)
- [ ] Cover letter / pitch (Noema model structure: hook → tension → plan → solutions → characters → differentiation)
- [ ] AI-collaboration disclosure paragraph (Noema variant; from template file)
- [ ] Three-word subheadings per Noema preference (one per section break)
- [ ] Hyperlinks on factual references (1–2 words per link per Noema preference)
- [ ] Image suggestions per Noema preference
- [ ] Author bio (~75–100w; from `publishing/book-proposal/03_author-platform.md` once polished)
- [ ] Path B no-overlap discipline verified — no sentence reuse between Ch 1 and the essay
- [ ] Send: cold submission to `edit@noemamag.com`
