...
## Canonical set (Chesapeake reef / Restitution Bond) — ADDED 2026-06-10 (TA §11.12; status: Ch 3 side DONE 2026-06-11; §11.12 pending 3 author calls)
...
**Cascade:** Ch 3 PROMOTED 2026-06-11 carrying the chapter-side claim — **GATE 2 SATISFIED**; remaining hold on the TA package = author ratification of three flagged §11.12 calls (Wilberg/Woods bib additions; §10.2 census wording; Thm 10.1b note). Any reef-touching essay/op-ed inherits these pinned labels (Atlantic main first). TA §11.12 + §3.6 reef row + §10.2 census + §5.5/§1.7/§1.10/Thm 10.1b/§17.5/§11.7 reconciliations all ride the MERGE-HOLD branch.
