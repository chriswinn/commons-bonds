...
**2. Hillbilly Elegy cross-reference.** Ch 1 guidance references it as part of the framework's intellectual origin ("the Hillbilly Elegy critique that started the intellectual thread"). Not in Ch 2 directly. Expansion could use J.D. Vance's memoir as a foil — Vance's frame places the cost-bearing on individual-cultural-failure (learned helplessness, "hillbilly culture"), while the cost-severance frame places it on structural allocation asymmetry. The cost-severance frame explains the same outcome without requiring the cultural-failure narrative. Ch 2 could reference this explicitly or leave the critique implicit in the counterargument handling.

**3. Opioid pandemic connection.** Ch 2 notes the 141/100,000 drug death rate (10× national) but does not connect this to the opioid distribution pipeline. Expansion: the DEA's own tracking showed coal-dependent communities in Appalachia received opioid shipments at rates wildly disproportionate to population — this is spatially and temporally downstream of the same extraction pattern. Workers disabled by black lung and other occupational injuries became the target market. The "diseases of despair" framing (Case & Deaton) connects. Cost severance operating through a second extraction cycle: after the coal cost-severance depleted the community, the pharmaceutical cost-severance extracted what was left.

**4. Industry-accountability cases in the opioid pipeline.** Chris mentioned "DuPont being found guilty of creating sales plans that essentially created the opioid pandemic." Flagging for verification: DuPont's notable West Virginia accountability case is the C8 / PFAS (Teflon) contamination around Parkersburg — different issue, same geography. The pharmaceutical-industry opioid accountability cases are typically Purdue / Sacklers (OxyContin marketing, bankruptcy) and the Big Three distributors (McKesson, Cardinal Health, AmerisourceBergen) who settled for $21B in 2022. Verify which specific case Chris intended. Whichever the intended case, it functions as the opioid equivalent of the coal companies' dust-regulation resistance — knowing the harm, designing the marketing anyway, using bankruptcy/settlement to escape full liability.
