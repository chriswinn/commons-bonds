...
- **Relevance:** Ostrom is the canonical intellectual ancestor for collective-management-of-commons arguments. Commons Bonds extends Ostrom's institutional-design frame to **extraction contexts** where the commons cannot be managed in-place (fossil fuels, non-renewable minerals, climate stability).
- **Relationship:** **STRONG SUPPORT.** Ostrom's work is the friendly precedent the framework stands on and extends. Ostrom governed commons that could be managed in-perpetuity; Commons Bonds addresses commons that are drawn down during extraction and must be priced for intergenerational fairness rather than managed for sustained yield.
