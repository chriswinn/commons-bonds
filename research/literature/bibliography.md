...
- **Path B note:** Pass 3.1 fact-check verified Marx attribution accuracy ("who labors" gloss accurate to *Capital* Volume I labor-theory-of-value tradition); see [`tools/rigor-passes/commons_bonds_rigor_pass_2026-05-23_atlantic_ideas_essay_factcheck_v1.0.0.md`](../../tools/rigor-passes/commons_bonds_rigor_pass_2026-05-23_atlantic_ideas_essay_factcheck_v1.0.0.md) F-3.1-3 + F-3.1-20.
