...
**Four preference categories** (have these in mind, ready to clarify if Darity asks):
...
These match the Darity pre-read brief verbatim. Sandy will have read them in advance.
...
**Live-interview discipline:** plan to land Q1-Q5 in the first 30 min if a 45-min interview, or first 25 min if a 30-min interview. Don't rush; if a question lands deep, follow it. If a question lands shallow, move on.
...
Brief notes on what to draw out + what to push on if Sandy gives a short answer to any priority question. Use only if needed; don't lead with these.
...
## Pivot anticipations — Sandy might go any of these directions
...
If Sandy says he wants to review the formal apparatus or the math chapter:
...
If Sandy declines the warm intro, that's fine — the Mullen path was contingent and not load-bearing.
