...
- **Outreach pipeline (state per v1.52.0 + post-handoff updates through 2026-05-08):**
  ...
  - **Allison Colden** (CBF Maryland): response SENT 2026-05-06 via gatekeeper Val DiMarzio. 7-question batch stashed at `research/outreach/questions-draft_2026-05-05_colden-if-val-accepts.md`. Outcomes drive Ch 3 drafting + Noema §V third-anchor decision — gated on **interview material *or* sufficient public-record prep** per the 2026-05-08 de-risking decision (see `decisions-log.md` 2026-05-08 (De-risk Colden + Moore) entry; parallel public-record brief queued in manuscript/outreach thread, mirroring Darity + Dagan methodology).
...
- **A** — Begin Noema rewrite using Path B structure once Colden gating resolves (interview material *or* sufficient public-record material per 2026-05-08 de-risking decision). **§V third-anchor decision** finalizes among Chesapeake fisheries / Mondragon / Vienna / Ecuador-Whanganui / Amsterdam DEAL once CBF tracks resolve OR public-record prep yields enough material.
...
6. Once Colden + Moore CBF tracks resolve (~3 wk window from 2026-05-06 sends) **OR public-record prep yields sufficient material** (whichever lands first per the 2026-05-08 de-risking decision), confirm Noema §V third-anchor among Chesapeake fisheries / Mondragon / Vienna / Ecuador-Whanganui / Amsterdam DEAL.
