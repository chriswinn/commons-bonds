---
artifact: Atlantic Ideas — Gather-phase citation verification (two-state model)
date: 2026-06-02
status: GATHER-VERIFY OUTPUT
pipeline: "Amendment E Gather phase — the step skipped in the 2026-06-02 test run, run retroactively"
purpose: Verify the tentative citations the new-pipeline test draft wrote-around or omitted; demonstrate the tentative→confirmed two-state citation model with provenance.
---

# Gather-phase citation verification — Atlantic Ideas (2026-06-02)

The 2026-06-02 new-pipeline test run drafted from the existing Stage-1 brief,
which defers figure-verification to Stage-3 fact-check. That meant the **Gather
phase + two-state citation model were skipped** — the visible cost being two
citations the drafter (correctly, per no-invented-claims) wrote around or
omitted. This artifact runs the Gather verification retroactively and records
each citation's state. It directly answers the author's two questions
...
| # | Citation | State | Finding (with provenance) | Draft treatment | Recommendation |
|---|---|---|---|---|---|
...
- The **two-state model works as designed**: harvested citations are validated
  *before* they can be stated as confirmed; those that don't verify stay
  tentative and are written-around or omitted rather than asserted.
- Running Gather *first* (as the real pipeline prescribes) would have produced
  the *same* draft decisions on #1–#4 — confirming that the test draft's
  citation handling was sound, not lucky. The only difference: it would have
  been a deliberate, recorded verdict rather than an in-draft judgment call.
- Net for the essay: it already states the one solidly-verifiable figure
  ($14T) and correctly avoids the two that don't hold up. No fabrication; no
  over-claim.

## Sources

- [Darity & Mullen — $14T (CNBC, 2023-01-28)](https://www.cnbc.com/2023/01/28/reparations-owed-to-black-americans-william-darity-kirsten-mullen.html)
- [From Here to Equality, 2nd ed. (UNC Press / Amazon listing)](https://www.amazon.com/Here-Equality-Second-Reparations-Twenty-First/dp/1469671204)
- [House of Debt (Univ. of Chicago Press)](https://press.uchicago.edu/ucp/books/book/chicago/H/bo20832545.html)
- [Mian & Sufi — Debt, Great Recession and the Awful Recovery (moneyandbanking.com)](https://www.moneyandbanking.com/commentary/2014/7/17/debt-great-recession-and-the-awful-recovery)
