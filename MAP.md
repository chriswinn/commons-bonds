...
| `core/` | **The framework apparatus.** Technical Appendix + glossary + terms + methodology. | `technical-appendix/TechnicalAppendix_v2.0.0.html` (canonical TA, formulas live ONLY here); `glossary/...v4.html` (canonical); `terms/terms_index.md`; `technical-appendix/symbol-registry_2026-06-07.md` (notation source of truth) | Chapters. (Historical chapter/case-study *audits* that used to sit in `core/chapters/` + `core/case-studies/` now live in `tools/audits/`.) |
...
| `research/` | **Source material.** Case studies, bibliography master, outreach, story substrate. | `literature/bibliography.md` (THE bibliographic source of truth, superset); `case-studies/` (17 case files); `outreach/subjects/<name>/` + consent tracker; `story-drafts/` (raw scene substrate) | Polished prose. The reader-facing bibliography (generated to `manuscript/back-matter/`). |
...
| The math / formulas / symbols? | `core/technical-appendix/TechnicalAppendix_v2.0.0.html` (formulas exist ONLY there); notation source: `core/technical-appendix/symbol-registry_2026-06-07.md` Part 7 |
