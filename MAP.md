...
|---|---|---|---|
| `manuscript/` | **The book.** Chapters + front matter + back matter. | `chapters/Chapter__1..10*.md`; `_BOOK_MANIFEST.md` (the authority on "what is the book"); `back-matter/` (generated reader-facing bib/glossary/notation) | Nothing missing — the Technical Appendix now lives here in full (`technical-appendix/`, relocated 2026-06-10). Internal drafting inputs live in `manuscript/ledgers/`; superseded campaign state in `manuscript/archive/`. |
| `core/` (RETIRED 2026-06-10) | — | Gone. TA → `manuscript/technical-appendix/`; glossary/terms/bibliography sources → `tools/back-matter/sources/`; methodology → `alignment/methodology/`. | Anything — six top-level dirs remain: manuscript, publishing, research, tools, alignment, archive. |
...
| `research/` | **Source material.** Case studies, bibliography master, outreach, story substrate. | `tools/back-matter/sources/bibliography.md` (THE bibliographic source of truth, superset); `research/case-studies/` (17 case files); `research/outreach/subjects/<name>/` + consent tracker; `research/story-drafts/` (raw scene substrate) | Polished prose. The reader-facing bibliography (generated to `manuscript/back-matter/`). |
...
| Which sources back a figure? | `tools/back-matter/sources/bibliography.md` (+ `tools/back-matter/citation-crossref-index.md` for where-cited) |
...
- `manuscript/` `_`-prefixed root files + `manuscript/chapters/` + `tools/back-matter/sources/bibliography.md` — **redraft campaign**.
