...
| Technical appendix | **v0.0.4 canonical — Path F Section L (four-gate discipline) + Section M (formula generalization) landed 2026-04-24.** Dimension renames Atmospheric→Habitability, Geographic→Spatial, Demographic→Kindred, Ecological→Ecosystem applied. v0.0.3 retained in-place as prior canonical. | [`core/technical-appendix/TechnicalAppendix_v0.0.4.html`](core/technical-appendix/TechnicalAppendix_v0.0.4.html) |
...
| Tier reframing decision | **Reframing claim FAILS SC-1 on the §5.3 duplication check (2026-04-24).** 5 of 9 v10 tiers are variables (not groupings), 1 is pure C₁ duplication, 3 are ambiguous, 0 are clear groupings of multiple distinct sub-variables. **Recommended path: full dissolution of the tier schema; variables replace tiers at the framework-specification level.** Conditions 1–4 (+ optional 5, 6) pending author ratification at §11; implementation slated for Phase A3 or Phase B Task 12 integration. | [`tools/rigor-passes/commons_bonds_rigor_pass_2026-04-24_tier_reframing_v1.0.0.md`](tools/rigor-passes/commons_bonds_rigor_pass_2026-04-24_tier_reframing_v1.0.0.md) |
| Current handoff | **v1.39.0** | [`alignment/sessions/commons-bonds-session-handoff-2026-04-24_v1.39.0.html`](alignment/sessions/commons-bonds-session-handoff-2026-04-24_v1.39.0.html) |
