...
| Eight-tier decomposition | **RETIRED 2026-04-24** per tier-reframing rigor pass §11.2 (8-tier dissolution ratification). Path F + Four Gates discipline (per Insight #21 + tier-reframing) supersedes. **Archived 2026-04-30** per Insight #55 hygiene pass. | [`archive/decomposition/eight-tier-v10.html`](archive/decomposition/eight-tier-v10.html) |
