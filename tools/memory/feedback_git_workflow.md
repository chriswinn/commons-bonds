...
- **Internal-scaffolding auto-merge extension (added 2026-05-24):** The merge-to-main boundary is now drawn explicitly between **end-user-facing prose** (chapters; essay drafts at `publishing/essays/<venue>/essay.md`; op-ed canonical drafts at `publishing/op-eds/<slug>/op-ed.md`; book proposal; outreach content sent to subjects; cover letters/pitch emails) and **internal scaffolding** (everything else — rigor passes, PM dashboards, workstream handoffs, memory entries, templates, cascade plans, decisions logs, research notes, alignment docs, README files, CLAUDE.md, etc.). End-user-facing prose changes require author ratification before merge. Internal scaffolding ALL auto-fast-forward merges to main at session close. Rationale: the risk of losing work by forgetting to push is bigger than the risk of pushing premature internal scaffolding to main, since only the author sees internal scaffolding and any issue can be iterated again. Canonical doctrine: `CLAUDE.md` "Branch discipline + merge-to-main" section. (Path update 2026-05-25: essay + op-ed prose reorganized into per-essay/per-op-ed submission package directories under `publishing/essays/` and `publishing/op-eds/` per the publishing-pipeline reorg.)

**Supersedes** the earlier session-handoff memory rule "Direct-to-main git workflow; push each commit as it lands." Direct-to-main is preserved at the ratified-chunk level for end-user-facing prose, and at the auto-merge-everything level for internal scaffolding (2026-05-24 extension).
