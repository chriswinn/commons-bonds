...
- **Σ1 Public Choice rent-seeking-blindness (§5 Accountability Bond architecture):** TA does not engage Public Choice rent-seeking analysis directly. **Cross-chapter rent-seeking-engagement workstream in flight** (TA is a touched artifact; rent-seeking analysis material may land in TA §5.5 or new section per workstream handoff). Until the workstream produces material: pre-pub queue flag for external Public-Choice-tradition reviewer (technical-economics + Virginia-School-tradition affiliation; Mercatus / GMU cluster or similar) to test whether TA's current §5 + §15.1 prose holds against Public Choice critique.
...
**Scope of review:** §5 Accountability Bond architecture (rent-seeking-institutional-design analysis); §15.1 limitations section (Public Choice critique engagement); cross-chapter rent-seeking-engagement workstream's substantive material when it lands in TA §5.5 or new section.

**What to look for:**
- Does §5 Accountability Bond architecture engage rent-seeking-by-bond-administrators?
- Does §15.1 limitations section name Public Choice critique?
- Does the cross-chapter rent-seeking-engagement workstream's TA-side material adequately address the Public-Choice tradition's substantive contribution?
