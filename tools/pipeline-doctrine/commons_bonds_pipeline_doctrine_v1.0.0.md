...
5. **Source manifest (inline-citation pieces — essays + op-eds; Amendment E refinement §14.8, 2026-06-02).** A per-essay sheet mapping every inline citation / factual claim → its source → verification status (verified / needs-pin / soft / written-around / figure-currency). Magazine essays cite inline and ship NO bibliography; the manifest is the fact-check support sheet that travels with the submission package (it is what the venue's assigned fact-checker works from). Books carry a bibliography instead; essays/op-eds carry this. Lives at `publishing/essays/<venue>/source-manifest.md`. Reference instance: the Atlantic Ideas manifest; template: [`tools/drafting-templates/source-manifest-template.md`](../drafting-templates/source-manifest-template.md).
...
**§14.8 Source manifest as a standard pre-pub artifact (refinement, ratified 2026-06-02).** For **inline-citation pieces (essays + op-eds)**, the Stage 5 pre-publication review queue now includes a **source manifest** as a standard component (§7.1 item 5): a sheet mapping every inline citation / factual claim → source → verification status. Rationale: magazine essays cite inline and ship **no bibliography** (appending one reads as a category error to a magazine editor — bibliographies belong to books and journals); the manifest is the internal fact-check support sheet that travels with the submission package and is what the venue's assigned fact-checker works from. The **book** carries the bibliography (`research/literature/bibliography.md`); **essays/op-eds carry the manifest**. The two stay distinct so per-essay citation tracking does not duplicate or drift from the master bibliography (the 2026-06-02 Marx-entry sync was the empirical anchor for that drift risk). Location: `publishing/essays/<venue>/source-manifest.md`; template: `tools/drafting-templates/source-manifest-template.md`; reference instance: the Atlantic Ideas manifest.
