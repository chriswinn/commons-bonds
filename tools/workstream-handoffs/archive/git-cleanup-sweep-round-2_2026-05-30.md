...
- The `pm-cascade-v2-amend-morning-260527-1b419b` worktree initially had `dirty=1` (untracked 256-line, 16,913-byte PM dashboard `tools/workstream-handoffs/archive/pm-session-handoff_2026-05-28-portfolio-aeon-pattern-complete.md`).
