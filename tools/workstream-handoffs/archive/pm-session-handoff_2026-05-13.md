...
|---|---|---|---|---|
| **4** | **HIGH** | Outreach pipeline | 6 subjects in motion. **Darity TODAY 14:00 ET.** CBF response auto-sends **Wed May 20 8am EDT** (`b200664`). Colden citation-verify packet pre-staged (`15c6b0f`). Biggie process guide pre-staged (`164b9e2`). [handoff](tools/workstream-handoffs/archive/outreach-pipeline-handoff_2026-05-09.md) | Conduct Darity interview; synthesis tonight/tomorrow; Sandy email May 14–16; user-action send Colden packet. |
| **20** | **HIGH** | Manuscript Stage-3 Rigor Pass | Chs 1–4 partway; Chs 5–10 not started — **critical path bottleneck**. See per-chapter detail in §6. [handoff](tools/workstream-handoffs/archive/manuscript-stage-3-rigor-pass-handoff_2026-05-11.md) | Per §6 per-chapter "next action" column. |

### 5.2 READY TO FIRE

| # | Pri | Workstream | Status | Fire window |
|---|---|---|---|---|
| **1** | **HIGH** | Aeon pitch | Version C ratified 2026-05-08; Stage 3 verdict 2026-05-10 confirmed Version C beats Pitch B decisively. [handoff](tools/workstream-handoffs/archive/aeon-submission-handoff_2026-05-09.md) | **Sun May 31 14:01 UTC** (= Mon Jun 1 ~00:01 AEST). Pre-submission verify 1–2d prior. |
| **16** | MED | $100 Barrel essay → Phenomenal World | Q1 verdict flipped CONDITIONAL → **GO** (`b7fd20f`). Condition 1 (non-partisan framing) carries forward. [handoff](tools/workstream-handoffs/archive/100-barrel-essay-handoff_2026-05-11.md) | Fire Session 2 — Stage 1 audience-aware brief w/ Condition 1 embedded. |
| **2** | MED | Boston Review essay | UNBLOCKED 2026-05-10 by meta-verdict. v2.0 discipline embedded. Not drafted. [handoff](tools/workstream-handoffs/archive/boston-review-essay-handoff_2026-05-09.md) | When bandwidth permits. Pitch ~1pp + essay ~4,500w from Ch 5. |
| **14** | MED | Comp-titles deep matrix Phase 2 | Just-in-time verification deferred from #11. [handoff](tools/workstream-handoffs/archive/comp-titles-deep-matrix-phase-2-handoff_2026-05-11.md) | Early-to-mid July 2026 (2–3wk before Wave 1). |
| **18** | LOW | Ch 6 .html → .md conversion | Convenience cleanup; independent of #17. [handoff](tools/workstream-handoffs/archive/ch6-html-to-markdown-conversion-handoff_2026-05-11.md) | ~1–2h focused session. |
| **19** | LOW | Tech Appendix Scheme-4 cleanup | Deferred Scheme-4 work from #15. [handoff](tools/workstream-handoffs/archive/appendix-scheme-4-cleanup-handoff_2026-05-11.md) | Smaller-scope follow-up. |

### 5.3 WAITING / BLOCKED / DORMANT

| # | Pri | Workstream | Gated on | Target |
|---|---|---|---|---|
| **5** | **HIGH** | Book proposal | #20 completion | Late-June 2026 sprint (~3wk). Skeletons up; §05 chapter summaries landed (`733ba8e`). [handoff](tools/workstream-handoffs/archive/book-proposal-handoff_2026-05-09.md) |
| **6** | MED | Agent prep / target list | #20 + #5 + #14 | Wave 1 late Jul / early Aug 2026. 1/25 populated (Chalfant/Wylie). [handoff](tools/workstream-handoffs/archive/agent-prep-handoff_2026-05-09.md) |
| **3** | MED | Berggruen Prize essay | AI-free constraint (user-only) | Soft 2026-08-05; hard 2026-08-17. [handoff](tools/workstream-handoffs/archive/berggruen-track-handoff_2026-05-09.md) |
| **12** | LOW | Aeon essay post-acceptance | Aeon acceptance of #1 | Dormant. [handoff](tools/workstream-handoffs/archive/aeon-essay-post-acceptance-two-stage-handoff_2026-05-10.md) |
| **17** | LOW | Publishing pipeline (md→docx + html→pdf) | First submission deliverable queued | Trigger = book proposal completion / sample-chapter request / full manuscript request. [handoff](tools/workstream-handoffs/archive/publishing-pipeline-handoff_2026-05-11.md) |
...
- [x] **Ch 5 + Ch 6 Pass 3 ratified as-proposed** — clean READY TO SUBMIT AS-IS verdicts; three-pass cycles closed for both chapters.
- [x] **All Darity-synthesis manuscript-scope items verified RESOLVED** in Ch 6 prose — MI-3 (lines 256 + 262), SI-2 (line 25), C-3 (line 262), SI-3 (line 250); see §2 Wed May 13 row for full inventory.

### This week (by Sun May 17)
- **Author decision logged 2026-05-14: proactive Q0 tier-S citation outreach to Sandy** — three paragraphs (Ch 5 line 220, Ch 6 line 124, Ch 6 line 262) need personal-communication citation clearance per Sandy's Q0 tier-S protocol; author will reach out proactively rather than wait for reply. **Next action:** draft proactive Q0-citation-question note to Sandy modeled on the 2026-05-13 post-interview-confirmation-email voice; raise all three paragraphs together so Sandy can ratify in one round. File at `research/outreach/subjects/darity/proactive-q0-citation-questions_<DATE>.md` (DRAFT-first convention per the packet-send pattern). Send sooner-rather-than-later — earlier is better while Sandy hasn't yet read the packet (saves him from one read-then-second-pass cycle).
- [x] **Optional ~30min TA scope/grounding verification session — COMPLETE 2026-05-15.** Both mirrors verified present + attributed: TA §1.10 line 604 carries the heterogeneous-stakeholder-commons + stratification-economics paragraph with `(Darity 2026)` (mirrors Ch 6 line 262 / MI-3); TA §5.4 line 1342 carries the Parfit / Sen pairing with `(Darity 2026)` (mirrors Ch 6 line 250 / SI-3). Result: clean — no targeted-paragraph additions needed, no Sandy bundle generated. Full verification note at [`research/outreach/subjects/darity/ta-scope-grounding-verification_2026-05-15.md`](../../../research/outreach/subjects/darity/ta-scope-grounding-verification_2026-05-15.md). Ch 6 prose inline-citation propagation at lines 250 + 262 remains pending Sandy Q0 ratification (separate workstream).
...
- **Fire Chs 7–10 Phase A** as bandwidth permits — critical path bottleneck (Chs 5 + 6 now closed; remaining 7–10 are the active Phase A targets)
...
- **Darity cross-thread C-1 — Fogel-Engerman two-volume model (*Time on the Cross*)** → comp-titles workstream (#14). Sandy's call hint about handling manuscript-plus-appendix scale when the agent conversation gets serious. Add as a comp-title candidate when #14 Phase 2 fires (early-to-mid July). Acknowledge in author-and-appendix-structure section of book proposal §04 when #5 sprint runs. Standing reference: `research/outreach/subjects/darity/post-interview-synthesis_2026-05-13.md` C-1 entry.
- **Darity cross-thread C-2 — Du Bois bibliography addition** → bibliography Phase A workstream (§7 apparatus). Sandy's pointer for the framework's intellectual-history grounding. Add to bibliography during the per-chapter engagement-flag pass (specifically: wherever the Ch-5/Ch-6 reparations-economics lineage section references the tradition Du Bois grounds). Standing reference: `research/outreach/subjects/darity/post-interview-synthesis_2026-05-13.md` C-2 entry.
