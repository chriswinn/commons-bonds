...
Produce inventory at `tools/workstream-handoffs/archive/appendix-numbering-audit-inventory_2026-05-11.md` (or successor date) listing each section with its current dual labels (if any) + a recommended canonical label.
...
- `tools/workstream-handoffs/archive/apparatus-register-sweep-handoff_2026-05-10.md` (parent context; hard dependency)
