...
- **Status to look for:** `STATE: RATIFIED + APPLIED` at session close → ready for Stage 3 Pass 3.2 voice-polish session firing (Pass 3.2 kickoff paste-text expected to land at `tools/workstream-handoffs/archive/ch2-harpers-stage-3-pass-3-2-voice-polish-kickoff_2026-05-27.md` produced by the Pass 3.1 session per Wave 1 + Ch 4 precedent).
...
- **The Pass 3.2 voice-polish kickoff paste-text** at
  `tools/workstream-handoffs/archive/ch2-harpers-stage-3-pass-3-2-voice-polish-kickoff_2026-05-27.md`
