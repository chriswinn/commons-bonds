...
- **`tools/back-matter/sources/bibliography.md`** — standalone WORKING master (~24 sections, ~170 entries incl. agency sources §23/§24; heavy scaffolding: Status / Rigor-provenance / candidate-flags / character-notes / commit-refs). This is the SUPERSET.
...
- `tools/back-matter/sources/terms_index.md` (~1,915 lines) — internal term-provenance SOURCE.
- `tools/back-matter/sources/glossary/commons_bonds_updated_glossary_v{2,3,4}.html` — THREE reader-facing glossary versions (dedup to one).
...
| C | Glossary | `tools/back-matter/sources/terms_index.md` |
| D | References / Bibliography | `tools/back-matter/sources/bibliography.md` (the SUPERSET — NOT the TA §18 subset) |
