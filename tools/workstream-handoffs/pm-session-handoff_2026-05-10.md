...
| 15 | **Tech Appendix numbering reconciliation + chapter cross-reference re-validation** | [appendix-numbering-reconciliation-handoff](appendix-numbering-reconciliation-handoff_2026-05-11.md) | NEW 2026-05-11. Surfaced during apparatus sweep #9. **UNBLOCKED 2026-05-11** by #9 final-deliverable commit `bbf06f2`. Tech Appendix runs dual-numbering (§1–§9 numeric AND Section A–M letter) for same content; cascade effect: chapter cross-references use mixed schemes. Recommend numeric canonical. Also surfaces a layman-lookup discipline (named content + precise reference) worth standardizing book-wide. | Audit; pick canonical; apply across appendix; re-validate all chapter cross-references; resolve line-4868 "supplement §7" intent question. | None blocking — workstream-ready. | Fresh session |
