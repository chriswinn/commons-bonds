...
| 16 | **$100 Barrel essay** (derivative from withdrawn Noema §III; Phenomenal World primary target) | [100-barrel-essay-handoff](100-barrel-essay-handoff_2026-05-11.md) | NEW 2026-05-11. Surfaced by cross-chapter consistency audit (#10). Q1 publishing-strategy rigor pass landed 2026-05-11 (`76d6fcf`) with verdict CONDITIONAL — proceed with specific scope-adjustments + PM Session 2b/2c verification queued. Apply v2.0 audience-aware drafting; PW-specific Stage 1 brief; gas-price news peg (soft urgency, ~1–2 weeks). | Verify rigor-pass conditions; if ratified, fire Stage 1 brief session. | None blocking; conditions pending author review. | Fresh session pending |
...
| 18 | **Ch 6 .html → .md conversion** (companion to publishing pipeline #17; independent) | (no dedicated handoff yet; small bounded session) | NEW 2026-05-11. ~1–2h focused session; eliminates Ch 6 hybrid-format anomaly. Pipeline (#17) handles Ch 6 in either format, so this is convenience not requirement. | Convert Chapter__6_ThreeWaysofCounting__Draft.html → .md preserving math + semantic structure. | None blocking; independent of #17. | Fresh session when convenient |
