...
| 15 | **Tech Appendix numbering reconciliation + chapter cross-reference re-validation** | [appendix-numbering-reconciliation-handoff](appendix-numbering-reconciliation-handoff_2026-05-11.md) | NEW 2026-05-11. Surfaced during apparatus sweep #9 (commits `cf682be` + `16876a1` + `ede6d88`). Tech Appendix runs dual-numbering (§1–§9 numeric AND Section A–M letter) for same content; cascade effect: chapter cross-references use mixed schemes. Recommend numeric canonical. Also surfaces a layman-lookup discipline (named content + precise reference) worth standardizing book-wide. | Audit; pick canonical; apply across appendix; re-validate all chapter cross-references; resolve line-4868 "supplement §7" intent question. | **HARD BLOCKED on #9 Items 11–15 landing** (rebase conflict risk on chapter files). | Future session, after #9 lands |
...
- [x] **Tech Appendix numbering reconciliation workstream stood up** at `tools/workstream-handoffs/appendix-numbering-reconciliation-handoff_2026-05-11.md` + dashboard row #15 added. Blocked on apparatus sweep #9 finishing.
...
- [ ] **Tech Appendix numbering reconciliation + chapter cross-reference re-validation** (#15). Handoff stood up 2026-05-11; **BLOCKED on apparatus sweep #9 finishing Items 11–15.** Layman-lookup discipline (named content + precise reference) will become a book-wide standard via this workstream.
