...
- `tools/back-matter/sources/bibliography.md` — §23.3 corpus-wide figure sources + §18 DAC/SCC papers + Darity-packet recoveries (Bassett-Bell/Darity JAMA 2022; Colden 2017 MEPS; etc.).
