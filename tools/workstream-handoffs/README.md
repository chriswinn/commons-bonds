...
| **Render-pipeline-standardization** — Stage 4 canonical-pipeline decision (laptop `build-derivatives.sh` vs mobile-device conversion vs dual-pipeline). Surfaced 2026-05-17 by author observation that mobile renders better than current laptop pipeline. **BLOCKS retrofit Stage 4 audits** until resolved. Comparison-render + diagnosis + author-ratified decision; updates Stage 4 doctrine §3.3 canonical-pipeline flag. | `render-pipeline-standardization-handoff_2026-05-17.md` | `claude/render-pipeline-standardization-` |
