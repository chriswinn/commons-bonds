...
| **Mariana Mazzucato** | UCL/IIPP | **DECLINED via Adam Albrecht** | 2026-05-21 | "Existing work commitments at this stage" — standard polite decline. Pattern 2 cite via published work unaffected; cross-thread #1 resolution path (c) closes. Acknowledgment reply queued. |
