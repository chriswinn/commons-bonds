...
8. `tools/workstream-handoffs/manuscript-stage-3-rigor-pass-handoff_2026-05-11.md` (per-chapter table; Ch 8 row — analytical-quantitative register + arithmetic-load risk + multi-component walk cadence).
