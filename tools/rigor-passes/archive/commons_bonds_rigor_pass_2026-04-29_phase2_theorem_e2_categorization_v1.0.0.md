...
- [Three Ways + RCV Formal Model rigor pass 2026-04-24](tools/rigor-passes/archive/commons_bonds_rigor_pass_2026-04-24_three_ways_rcv_formal_model_v1.0.0.md) — RATIFIED 2026-04-24 commit `1c8e4dd`; cross-model architecture (Damage Function + Real Options + RCV) ratified.
