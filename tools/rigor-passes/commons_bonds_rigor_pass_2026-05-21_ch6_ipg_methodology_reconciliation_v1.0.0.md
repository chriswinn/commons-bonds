...
4. [manuscript/chapters/Chapter__2_TheMiner.md](manuscript/chapters/Chapter__2_TheMiner.md) line 121 — canonical home for the McDowell IPG framing ("between 33 and 122 times the price the coal actually sold for, depending on which cost categories you include and which social cost of carbon estimate you use for the combustion tail"; "the floor is 33 times"; "Chapter 8 walks the floor-estimate version . . . the per-ton honest price that chapter calculates lands at the upper end of this range").
