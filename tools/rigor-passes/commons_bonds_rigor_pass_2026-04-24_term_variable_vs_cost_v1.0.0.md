...
**Where:** `tools/rigor-passes/commons_bonds_rigor_pass_2026-04-24_path_f_variable_addability_v1.0.0.md`, `_tier_reframing_v1.0.0.md`, `_macro_grouping_v1.0.0.md`.
...
**Rigor provenance:**
- `tools/rigor-passes/commons_bonds_rigor_pass_2026-04-24_term_variable_vs_cost_v1.0.0.md` (2026-04-24) §15 — Option B (replace "variable" with "cost") recommended at full extreme rigor. Pending author ratification.
- `tools/rigor-passes/commons_bonds_rigor_pass_2026-04-24_path_f_variable_addability_v1.0.0.md` (2026-04-24) §3 — Cᵢ admissibility via gates established; class-term naming not resolved there.
- `tools/rigor-passes/commons_bonds_rigor_pass_2026-04-24_tier_reframing_v1.0.0.md` (2026-04-24) §5.3 — dissolution confirmed variable-level as unit of measurement; reinforced Cᵢ atomic role.
