...
| Path | Notes |
|---|---|
| `core/glossary/commons_bonds_updated_glossary_v2.html` | Superseded prior glossary version. Header note pointing to v3 + terms_index. |
...
| `tools/rigor-passes/commons_bonds_rigor_pass_2026-04-24_term_value_capture_vs_extraction_v1.0.0.md` | All instances | Preserve. This IS the retirement decision document. |
...
| File | Status |
|---|---|
| `core/glossary/commons_bonds_updated_glossary_v2.html` | Has standalone "Value Capture" entry. Per Tier 2: keep entry intact + add header note to v2 file referencing v3 + terms_index. |
