...
**UPDATE 2026-06-09 — DONE on the provenance-resume branch (gate already met here).** Re-verified current state (not the stale "L917 still cites 1956" claim above): §3.5 line 920 = "Solow 1974 *Review of Economic Studies*"; a full-TA grep finds **zero "Solow 1956" in-text** (the M3 §3.5 swap is already merged into this branch). The §18 Solow-1956 entry was therefore a true orphan and was **removed** this session; the Solow-1974 §18 entry is kept (cited at §3.5 + 5 spots). Session E need not redo it on the merged tree — just confirm the removal survived the merge.
...
- **(9a) Black Lung "$44B cumulative payouts" — NOT LOCATABLE; ESCALATED (corpus-wide, not just TA).** Exhaustive search 2026-06-08: our bib + `research/citations` + `research/case-studies/appalachian-coal.md` (states it verbatim, "copied from Ch 2 draft," NO source) + GAO-18-351 + Brookings 2021 (both PDFs text-extracted — neither has a cumulative-benefits total) + 3 web searches + CRS R45261 (403). **The $44B is a corpus-wide UNSOURCED figure used in Ch 2 / Ch 6 / Ch 8 + the TA**, carried as self-citation. *Verified clean:* the $15.4B-by-2050 debt projection (GAO/Brookings) + borrowing-since-1979. *Also flagged:* the debt figure is inconsistent across the corpus — chapters "$4.6B" / GAO "$5.85B (Sept 2019)" / TA "$5.1B (Sept 2024)." **UPDATE 2026-06-08 (outreach-folder mining):** the Darity with-citations docs attribute it — Ch 6 says "**≈$44B through 2009 (GAO/CRS)**", TA §11.6 says "DOL OWCP / BLDTF annual reports" for a "56-year/Sept-2024 cumulative." The **through-2009-vs-2024 date split** means $44B is **likely a ~2009 figure presented as current** (stale). Probable home: CRS R45261 (403'd). Cleanest fix: relabel to "≈$44B through 2009 (GAO/CRS)" — honest + likely sourceable — or recompute current cumulative from DOL OWCP annual reports. **Action:** because it lives in the published chapters, this is an AUTHOR / chapter-session item, not a TA-only fix — locate the primary source (likely a DOL OWCP annual report or 2018–19 NPR/Ohio Valley ReSource reporting) OR relabel as estimate / recompute from OWCP annual benefit-outlay data; reconcile the debt vintage. Low headline-materiality in the TA (one addend in realized-B), but **reputational risk is corpus-wide** (an unsourced "$44 billion" in the book body). **Owner:** author + chapter session (not TA-only).
- **(9b) EIA 1960 coal price $4.50 → $4.71 — PARTIALLY APPLIED (status 2026-06-09).** EIA confirms 1960 bituminous mine-mouth = $4.71/short ton (all-coal $4.83); TA's $4.50 was sourced only to the internal Ch 6 table. **Actual $4.50 spots in the TA (6, per grep 2026-06-09 — supersedes the earlier "7 spots §3.3/§11.1/§11.6×3/§7.6/§14.7" estimate, which did not match the file):**
  - **§11.6 ×2 (L4487 table cell + L4750 V_option calibration) — DONE by Session D** on branch `ta-m3-pathb` commit `346ddf0` (also tightened the L4487 descriptor "1960 average coal price" → "bituminous mine-mouth" so $4.71 matches; MERGE-HOLD, not yet merged into the provenance branch, so these still read $4.50 here until merge). No headline impact — McDowell M3-IPG is price-independent (multiplier product) under Path A.
  - **4 remaining → Session C (correctness sweep), handed off by Session D 2026-06-09:** **L2919 §9.3** ("Market price remains $4.50/ton (1960 historical)") — safe mechanical swap; **L3093 §8 ARR worked example** ("Coal at $4.50/ton in 1960") — safe, conclusion is qualitative; **L3859 case-file table** ("$4.50–$18/ton period average") — safe, confirm the $4.50 is the 1960 basis; **L6629 §15** ("$504 of cost for every $4.50") — **ENTANGLED: this is a ratio pairing the $504 carbon-floor figure with the price; do it inside C's IPG/$504 recompute, NOT as a standalone swap** (swapping the price alone changes the implied 112× → ~107×; the $504 may also move with the A0 carbon cascade).
  **Owner:** Session C for the 4 remaining (apply $4.71 with the IPG recompute so the §15 ratio lands consistent); Session D done for §11.6. (Effect on the McDowell IPG is small and Path-A-independent.)

## Summary of ownership

| Item | Owner | Apply when |
|---|---|---|
| 1 IPG apparatus reframe | Session C — **BLOCKED on the 33–122× derivation (see 1b)** | **per Session D: M3-IPG is now a premium-MULTIPLE (~8.5–26×, ctr ~15×), NOT 50–555×; §9.5 67–134× is the cross-MODEL cell, left unchanged. Session C keeps §9.5 12-cell + §3.2 IPG=33 + §16.4 consistent + drops "canonical/documented" phrasing.** BUT can't relabel "documented/canonical" → "framework-computed, derivation shown" on a number whose computation doesn't reproduce — see 1b. |
| 1b McDowell IPG 33–122× — DOES NOT REPRODUCE (provenance finding, 2026-06-09) | **Session C flag, provenance-confirmed; recompute = C + D coordinated** | **Confirmed on the TA:** the 33–122× McDowell IPG does not reproduce from current post-cascade inputs, AND the TA gives two *inconsistent* derivations for it: §11.11 (L6235) says "damage cost ÷ 1960-nominal price" **and openly calls that an inconsistent, inflated basis** ("comparing present-dollar RCV against a 1960-nominal price … would inflate the ratio toward two orders of magnitude; on a consistent basis the lenses converge" to M3's 8.5–26×); §14.3 (L6579) calls it a discount-rate-sensitivity range. Against current numbers: $496 carbon ÷ $4.71 ≈ 105×; floor $504–518 ÷ $4.71 ≈ 107–110×; RCV $580–620 ÷ $4.71 ≈ 123–132× — none yield a 33–122× *range*. Likely a Ch-6-era convergence figure carried forward, never recomputed after the carbon ($510→$496) + price ($4.50→$4.71) cascades. **Spots:** §9.5 DF cell (L3147), §11.1 (L3888), §11.6 reconciliation cell (L4500), §11.11 (L6222/6235/6250), §14.3 (L6579), §16.4. **Recommendation:** C + D establish the canonical derivation (which damage figure ÷ which price basis, and what makes it a *range*) and recompute against current inputs; OR, if 33–122× is meant as the deliberately-inconsistent-basis lens, state the exact present-$-damage-÷-1960-price arithmetic so it reproduces. **Until it reproduces, the Item-1 reframe is correctly BLOCKED for every 33–122× spot** (incl. the terms_index cell) — agree with Session C. NB: my earlier "self-citation wording kill … derivations shown, 0 numbers changed" did NOT validate the 33–122× arithmetic; it removed the external-authority wording only. **Owner:** Session C (IPG) + Session D (§11.6 reconciliation cell / Ch6 convergence). |
...
| 3 Eco/Cohesion estimate-labels | **DONE 2026-06-09 (Path A)** | §11.6 reclamation $/acre (L4645) + community-replacement $/resident (L4662) relabeled as explicit framework engineering-substitute estimates, NO number change; cited the documented anchors — reclamation ~$12–15.5K/acre (Appalachian Voices 2021 / Yang & Davis 2021 / GAO-17-207R / OSMRE under-bonding); Isle de Jean Charles ~$48.3M/~37 hh ~$1.3M/hh (LOCD, VERIFIED 2026-06-09 → conservatism confirmed); Census 98,887→19,111 for the ~50K out-migration. Non-substitutable remainder routed to M3 (already noted in prose). **Peer-review hardening (Path A, 2026-06-09):** added a Method-1 **Sensitivity** statement after the combined anchor — Eco+Cohesion contribute <4% of the floor (~$30–90/ton vs ~$1,600–2,700/ton), are labeled estimates, result robust to them; full-restoration "worth more" claim explicitly routed to the M3 irreversibility premium, not asserted as an M1 dollar figure. NO number change. |
| 3b Eco-floor NUMBER re-anchor (Path B) | **REJECTED 2026-06-09 (Session C concept-check; agreed)** | Path B proposed re-anchoring the §11.6 Ecosystem M1 floor to the documented ~$12–15.5K/acre. **REJECTED:** Session C established the documented reclamation figure is a **SMCRA bond-reclamation surface cost** (~$7,600/acre, excludes long-term water treatment), i.e. a lower bound on *partial* surface reclamation — NOT an ecological-replacement cost. Anchoring Method 1 (replacement cost) to it would **understate** the floor, not refine it. So the posited Method-1 estimate is NOT replaced; Path A stands as the resolution. **Path A statement corrected 2026-06-09** to remove the clause that had endorsed the documented figure as a "more conservative anchor"; it now states the bond-reclamation spend is explicitly NOT used as the M1 anchor (would understate it). No number change. |
...
| 8 Solow orphan | **DONE 2026-06-09 (gate met on this branch)** | Verified on the provenance-resume branch: §3.5 (line 920) already cites "Solow 1974"; **zero "Solow 1956" in-text** (the M3 §3.5 swap is already merged here — the earlier "this branch still cites Solow 1956 at L917" note was STALE). §18 Solow-1956 entry was therefore orphaned → **removed**. Kept the Solow-1974 §18 entry (cited at §3.5 + 5 spots). |
| 9a Black Lung $44B | **AUTHOR + chapter session** | NOT locatable (GAO-18-351 + Brookings + repo all checked); corpus-wide unsourced (Ch2/6/8); locate primary source or relabel/recompute |
