...
| **Book proposal** | 00_overview **RATIFIED 06-09** (Stage 5); §00 + §05 recascaded to TA closeout figures 06-10; routed 67–134× residual RESOLVED (→ ≈61–115× per provenance Item 3) + stale BR "editor-review" platform claim fixed (BR REJECTED 06-03 → PW + ratified-queue framing) 06-10; Candidate 8 (rent-capture) logged + routed to action-list A6b + dashboard decision #10; TA-indexed figures flagged for refresh before assembly (~Jun 14–20, pre-agent gate per dashboard §5) | 06-10 (this session) | Sprint completes ~Jun 20; strip status header before send |
