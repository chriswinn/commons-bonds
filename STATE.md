...
| **Ch 3 Tangier erosion figure** | `claude/ch3-tangier-erosion-figure-260611-8e148c` | **RATIFIED + APPLIED + MERGED 06-11** (author: "ratify Option B"). Primary source verified (Schulte et al. 2015 via PMC full text): ~1.7 ft/yr avg Tangier proper / 66.75% lost since 1850 / ~1.2 sq mi remaining; NO 15 ft/yr in the paper (= USACE-via-press exposed-shore max). Phase C applied: dual-figure reframe at Ch 3:169 (press 15 ft = exposed-shore worst vs ~2 ft/yr long-term avg + two-thirds gone since 1850) + numeral-free litany at :262 + "two square miles" → "a bit over a square mile"; ledger shorthand clarified; automatic-on-edit cascade (3.1 + 3.2 + 1c-light) clean. Artifact: `tools/rigor-passes/commons_bonds_ch3_tangier_erosion_figure_correction_2026-06-11_RATIFIED-APPLIED.md`. Atlantic essay.md same figure — owned by in-flight redraft workstream (candidates A+B already corrected), no double-fix | 06-11 (this session) |
