...
| **Ch 3 Tangier erosion figure** | `claude/ch3-tangier-erosion-figure-260611-8e148c` | **PROPOSED — author ratification queue.** Promoted Ch 3 carries unqualified "fifteen feet a year" (lines 169 + 262) + "two square miles"; primary source (Schulte et al. 2015, verified against PMC full text this session) gives ~1.7 ft/yr avg (Tangier proper) / 66.75% lost since 1850 / ~1.2 sq mi remaining; 15 ft/yr = USACE-via-press exposed-shore max only. Register §2.10 / ledger correction confirmed RIGHT; chapter wrong before external ship. One-finding ask at `tools/rigor-passes/commons_bonds_ch3_tangier_erosion_figure_correction_2026-06-11_PROPOSED.md` (rec: dual-figure reframe at 169 per Atlantic redraft-candidate execution; numeral-free litany at 262). Atlantic essay.md same figure — owned by in-flight redraft workstream, no double-fix | 06-11 (this session) |
