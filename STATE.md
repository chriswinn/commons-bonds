...
| Unit | State | Verified | Next action |
|---|---|---|---|
| Chapters (10) | Content-complete; **redraft-compare campaign live**. **Ch 5 whole-cloth redraft COMPLETE + PROMOTED 06-09** (blind verdict PROMOTE-NEW-AFTER-FOLDIN; Polanyi/Fraser/Sandel in, $108T out, 0 em-dashes; fold-ins = Butler figures; ⚠ the 06-10 dashboard §3 row for Ch 5 is STALE — surveyed pre-promote). Ch 9 whole-cloth redraft queued (brief pre-written); Ch 8 spot-fix-vs-redraft = author decision #5; prose-smoothing campaign PROPOSED (dashboard §4, decision #7). Reverse-CSD/framework-core branch MERGED to main 06-10 (see Framework-core revision row); TA-closeout figures ride the numeric sweep | 06-10 (verified on disk) | Ch 5 fold-ins + numeric sweep + author redline → Ch 1 + Ch 5 Wave-1 samples |
